...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        @php
            $categories = [
                'Matic' => 'Harley Vario 160',
                'Sport' => 'Harley CBR 250RR',
                'EV' => 'Harley EM1 e:',
                'Big Bike' => 'Harley CB650R',
            ];
        @endphp
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Harley Beat</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Harley Scoopy</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Harley Genio</p>
