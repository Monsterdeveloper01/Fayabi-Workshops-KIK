...
>
    ...
    <section class="flex items-center gap-6">
        ...
        <div>
            ...
            <p class="text-slate-500 mt-1">
                Ready to Race – pilihan KTM terbaik di setiap kategori
            </p>
        </div>
    </section>
    ...
    @php
        $categories = [
            'Naked' => [
                'best' => '1290 Super Duke R',
                'others' => ['390 Duke', '790 Duke', '890 Duke R'],
            ],
            'Sport' => [
                'best' => 'RC 390',
                'others' => ['RC 200', 'RC 8C'],
            ...
            'Adventure' => [
                'best' => '890 Adventure R',
                'others' => ['390 Adventure', '1290 Super Adventure'],
            ],
            'Enduro' => [
                'best' => '500 EXC-F',
                'others' => ['350 EXC-F', '250 EXC-F'],
            ],
        ];
    @endphp
    ...
    <section class="space-y-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white border rounded-3xl p-6 shadow-sm">
                ...
                <button
                    @click="
                        motor.name = 'KTM {{ $category['best'] }}';
                        motor.image = 'https://placehold.co/900x500?text=KTM+{{ urlencode($category['best']) }}';

                        motor.specs = (
                            '{{ $category['best'] }}' === '1290 Super Duke R' ? [
                                'Mesin: 1301 cc, V-Twin',
                                'Tenaga Maksimum: 180 PS',
                                'Torsi Maksimum: 140 Nm',
                                'Transmisi: 6-percepatan + Quickshifter',
                                'Pendingin: Liquid-cooled',
                                'Fitur: Ride Mode, Launch Control, Cornering ABS'
                            ] :
                            '{{ $category['best'] }}' === 'RC 390' ? [
                                'Mesin: 373 cc, 1 Silinder',
                                'Tenaga Maksimum: 44 PS',
                                'Torsi Maksimum: 37 Nm',
                                'Transmisi: 6-percepatan',
                                'Pendingin: Liquid-cooled',
                                'Fitur: Slipper Clutch, Supermoto ABS'
                            ] :
                            '{{ $category['best'] }}' === '890 Adventure R' ? [
                                'Mesin: 889 cc, Parallel Twin',
                                'Tenaga Maksimum: 105 PS',
                                'Torsi Maksimum: 100 Nm',
                                'Transmisi: 6-percepatan',
                                'Pendingin: Liquid-cooled',
                                'Fitur: Off-road ABS, Traction Control'
                            ] : [
                                'Mesin: 510 cc, 1 Silinder',
                                'Tenaga Maksimum: ±60 PS',
                                'Transmisi: 6-percepatan',
                                'Pendingin: Liquid-cooled',
                                'Bobot: ±106 kg',
                                'Fitur: Enduro Race Suspension'
                            ]
                        );
