...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        <section class="flex items-center gap-6">
            ...
            <div>
                <h1 class="text-4xl font-black italic uppercase text-slate-900">Aprilia Motorcycles</h1>
                <p class="text-slate-500 mt-1">Pilihan motor Aprilia terbaik di setiap kategori</p>
            </div>
        </section>
        ...
        @php
            $categories = [
                'Matic' => 'Aprilia Vario 160',
                'Sport' => 'Aprilia CBR 250RR',
                'EV' => 'Aprilia EM1 e:',
                'Big Bike' => 'Aprilia CB650R',
            ];
        @endphp
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Aprilia Beat</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Aprilia Scoopy</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Aprilia Genio</p>
