...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        @php
            $categories = [
                'Matic' => 'Yamaha Vario 160',
                'Sport' => 'Yamaha CBR 250RR',
                'EV' => 'Yamaha EM1 e:',
                'Big Bike' => 'Yamaha CB650R',
            ];
        @endphp
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Yamaha Beat</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Yamaha Scoopy</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Yamaha Genio</p>
