...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        @php
            $categories = [
                'Matic' => [
                    'best' => 'Honda Vario 160',
                    'others' => ['Honda Beat', 'Honda Scoopy', 'Honda PCX 160'],
                ],
                'Sport' => [
                    'best' => 'Honda CBR 250RR',
                    'others' => ['Honda CBR 150R', 'Honda CB150R', 'Honda Sonic 150R'],
                ],
                'EV' => [
                    'best' => 'Honda EM1 e:',
                    'others' => ['Honda U-GO'],
                ...
                'Big Bike' => [
                    'best' => 'Honda CB650R',
                    'others' => ['Honda Africa Twin', 'Honda CBR1000RR-R'],
                ],
            ];
        @endphp
