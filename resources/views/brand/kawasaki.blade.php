...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        @php
            $categories = [
                'Matic' => 'Kawasaki Vario 160',
                'Sport' => 'Kawasaki CBR 250RR',
                'EV' => 'Kawasaki EM1 e:',
                'Big Bike' => 'Kawasaki CB650R',
            ];
        @endphp
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Kawasaki Beat</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Kawasaki Scoopy</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Kawasaki Genio</p>
