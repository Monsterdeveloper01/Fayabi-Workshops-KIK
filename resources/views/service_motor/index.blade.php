        ...
        <section class="max-w-2xl mx-auto my-6 px-4">
            ...
            <div class="bg-white rounded-[1.5rem] shadow-xl border-2 border-slate-200 overflow-hidden">
                <div class="bg-white p-6 border-b-4 border-red-600">
                    ...
                    <p class="text-slate-500 text-xs md:text-sm mt-1 font-bold">Lengkapi data kendaraan untuk pendaftaran service.</p>
                </div>
                ...
                <form action="#" method="POST" class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="space-y-2">
                        <label class="block text-[10px] font-black text-slate-900 uppercase tracking-widest">Catatan Keluhan Mesin</label>
                        <textarea rows="3" placeholder="Ceritakan masalah motor Anda..." 
