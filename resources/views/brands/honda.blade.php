    ...
    <div class="max-w-7xl mx-auto px-4 space-y-20">
        ...
        <section class="flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-1">Pilihan motor Honda terbaik di setiap kategori</p>
            </div>
        </section>
        ...
        @php
            $categories = [
                'Matic' => 'Honda Vario 160',
                'Sport' => 'Honda CBR 250RR',
                'EV' => 'Honda EM1 e:',
                'Big Bike' => 'Honda CB650R',
            ];
        @endphp
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Honda Beat</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Honda Scoopy</p>
                            ...
                            <div
                                ...
                                <div>
                                    <p class="font-bold text-slate-800">Honda Genio</p>
